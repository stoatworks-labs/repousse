...
/**
    ...
    **Buffers that could not be allocated.** This plugin holds three
    single-channel float buffers the size of the host's picture (the
    ground, and the two halves of the generalising blur), and the failure
    mode when the driver says no is a black frame with nothing to explain
    it. What goes in the log is the size asked for: at 4K the three come to
    about 100 MB.
*/
namespace repousse::diag
{
