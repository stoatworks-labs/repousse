...
| `--resize` | a resize mid-run with the punch, patina and shadows on matches a fresh instance in every one of 4,157,044 values; a swinging lamp follows an unresized run through it exactly |
