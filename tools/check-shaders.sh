...
#
#   tools/check-shaders.sh [path/to/rptest]
#
# The text compiled is what `rptest --dump-shaders` writes: the exact strings
...
dir="$( mktemp -d )"
"$RPTEST" --dump-shaders "$dir" >/dev/null
n=0; bad=0
