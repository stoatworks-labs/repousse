...
- **Tomas Akenine-Möller, Eric Haines, Naty Hoffman, Angelo Pesce, Michał Iwanicki and Sébastien Hillaire, *Real-Time Rendering*, 4th edition (CRC Press, 2018), Table 9.2** — the normal-incidence reflectance (F0, linear sRGB) of copper, brass (C260), silver, gold and iron (used here for steel). Quoted from the table as remembered; see AGENTS.md, "Open questions".
