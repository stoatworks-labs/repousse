...
Sheet metal worked from behind with punches and from the front with chasing tools, then lit. The two facts the model rests on, that the punch sets the finest detail and that metal is lit rather than shaded, are the craft's, not any one piece's. No code, assets or binaries from any source were used or examined.

## Standards and published specifications

What the implementation is measured against.

- **P. B. Johnson and R. W. Christy, "Optical constants of the noble metals", Phys. Rev. B 6, 4370 (1972), and "Optical constants of transition metals: Ti, V, Cr, Mn, Fe, Co, Ni, and Pd", Phys. Rev. B 9, 5056 (1974); M. R. Querry, "Optical constants", Contractor Report CRDC-CR-85034 (1985)** — The complex refractive indices of copper, silver and gold (1972), iron (1974, used for steel) and 70/30 brass (1985) from which the metal table's F0 is computed by tools/f0.py, as tabulated in the refractiveindex.info database (public domain, CC0 1.0): F0(λ) = ((n−1)² + k²)/((n+1)² + k²) integrated against the CIE 1931 2° colour-matching functions under illuminant D65 (both as published by CVRL, cvrl.org), taken to linear sRGB with the IEC 61966-2-1 matrix; gold's red, outside the sRGB gamut, is clamped to 1.
