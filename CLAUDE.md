...
## Not done yet
- Never loaded into Resolume on macOS. On Windows the DLL of this source ran in Arena 7.27.1 on win-lab (software rendering): 8/9 on the fleet gate, Cord Length, Damping and Swing unprovable on a still with no Kick.
